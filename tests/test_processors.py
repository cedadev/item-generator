...
from item_generator.extraction_methods.iso19115_extract import ISO19115Extract

from item_generator.extraction_methods.preprocessors import CEDAObservation
...
def test_iso19115_extract(iso19115_processor):
    ...
    expected = {
        'start_datetime': '2005-01-06T09:57:05'
    }
...
# TODO: Mock the call to catalogue server
def test_iso19115_processor_with_preprocessor_null_output(iso19115_processor, ceda_observation, caplog):
    """
